          ...
          <div className="max-w-md w-full">
            <div className="bg-white border border-slate-200 shadow-xl rounded-lg overflow-hidden">
              <div className="bg-[#0F172A] p-8 text-center">
                <h1 className="text-2xl font-black text-white tracking-tight uppercase">Acceso Restringido</h1>
                <p className="text-blue-200/60 text-[10px] font-bold uppercase tracking-widest mt-2">Ingresa la contraseña</p>
              </div>
